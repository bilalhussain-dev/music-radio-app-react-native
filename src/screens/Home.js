    ...
    <React.Fragment>
      ...
      <Animated.View style={[styles.containerHeader, { opacity: opacityOut }]}>
        <FontAwesome
             ...
             color={colors.white} name="sliders" size={20} />
      </Animated.View>
      ...
      >
        ...
        <AlbumsHorizontal data={recentlyPlayed} heading="Recently Played Songs" />

        <AlbumsHorizontal
          data={heavyRotation}
          heading="Your Music Stations"
          tagline="The music you've had on repeat this month."
        />

        <AlbumsHorizontal
          data={jumpBackIn}
          heading="Top Trending Songs"
